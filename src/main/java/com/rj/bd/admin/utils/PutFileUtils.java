...
public class PutFileUtils {
	private static String accessKey  = "e_5LiAOYf0arHhni5-6ZvXbPgSE7mrxyS8sortDA";
	private static String secretKey ="5h5Qcm0-N42H1C1mPBeEUa3WY6QVoVPpYJL35Ipj";
	private static String bucket="xyhqsub";
